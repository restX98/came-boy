...
static const cartridge_type_info_t cartridge_types[256] = {
    ...
    [0x19] = {NULL, "MBC5", false, false},
    [0x1A] = {NULL, "MBC5+RAM", true, false},
    [0x1B] = {NULL, "MBC5+RAM+BATTERY", true, true},
    [0x1C] = {NULL, "MBC5+RUMBLE", false, false},
    [0x1D] = {NULL, "MBC5+RUMBLE+RAM", true, false},
    [0x1E] = {NULL, "MBC5+RUMBLE+RAM+BATTERY", true, true},
