...
static const io_reg_region_t register_map[] = {
    ...
    {"Wave Pattern", 0xFF30, 0xFF3F, NULL, NULL},                           // 0xFF30–0xFF3F — Wave pattern
    {"LCD", 0xFF40, 0xFF4B, read_lcd, write_lcd},                           // 0xFF40–0xFF4B — LCD
    {"OAM DMA transfer", 0xFF46, 0xFF46, NULL, NULL},                       // 0xFF46 — OAM DMA transfer
    {"Boot ROM mapping control", 0xFF50, 0xFF50, NULL, NULL},               // 0xFF50 — Boot ROM mapping control
