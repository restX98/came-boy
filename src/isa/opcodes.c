...
opcode_fn opcode_cb_table[256] = {
    ...
    // Type: RRC r8
    [0x08] = op_rrc_r8,    // RRC B
    [0x09] = op_rrc_r8,    // RRC C
    [0x0A] = op_rrc_r8,    // RRC D
    [0x0B] = op_rrc_r8,    // RRC E
    [0x0C] = op_rrc_r8,    // RRC H
    [0x0D] = op_rrc_r8,    // RRC L
    [0x0E] = op_rrc_r8,    // RRC [HL]
    [0x0F] = op_rrc_r8,    // RRC A
    // Type: RL r8
    [0x10] = op_rl_r8,     // RL B
    [0x11] = op_rl_r8,     // RL C
    [0x12] = op_rl_r8,     // RL D
    ...
    // Type: BIT b3, r8
    [0x40] = op_bit_b3_r8, // BIT 0,B
    [0x41] = op_bit_b3_r8, // BIT 0,C
    [0x42] = op_bit_b3_r8, // BIT 0,D
    [0x43] = op_bit_b3_r8, // BIT 0,E
    [0x44] = op_bit_b3_r8, // BIT 0,H
    [0x45] = op_bit_b3_r8, // BIT 0,L
    [0x46] = op_bit_b3_r8, // BIT 0,[HL]
    [0x47] = op_bit_b3_r8, // BIT 0,A
    [0x48] = op_bit_b3_r8, // BIT 1,B
    [0x49] = op_bit_b3_r8, // BIT 1,C
    [0x4A] = op_bit_b3_r8, // BIT 1,D
    [0x4B] = op_bit_b3_r8, // BIT 1,E
    [0x4C] = op_bit_b3_r8, // BIT 1,H
    [0x4D] = op_bit_b3_r8, // BIT 1,L
    [0x4E] = op_bit_b3_r8, // BIT 1,[HL]
    [0x4F] = op_bit_b3_r8, // BIT 1,A
    [0x50] = op_bit_b3_r8, // BIT 2,B
    [0x51] = op_bit_b3_r8, // BIT 2,C
    [0x52] = op_bit_b3_r8, // BIT 2,D
    [0x53] = op_bit_b3_r8, // BIT 2,E
    [0x54] = op_bit_b3_r8, // BIT 2,H
    [0x55] = op_bit_b3_r8, // BIT 2,L
    [0x56] = op_bit_b3_r8, // BIT 2,[HL]
    [0x57] = op_bit_b3_r8, // BIT 2,A
    [0x58] = op_bit_b3_r8, // BIT 3,B
    [0x59] = op_bit_b3_r8, // BIT 3,C
    [0x5A] = op_bit_b3_r8, // BIT 3,D
    [0x5B] = op_bit_b3_r8, // BIT 3,E
    [0x5C] = op_bit_b3_r8, // BIT 3,H
    [0x5D] = op_bit_b3_r8, // BIT 3,L
    [0x5E] = op_bit_b3_r8, // BIT 3,[HL]
    [0x5F] = op_bit_b3_r8, // BIT 3,A
    [0x60] = op_bit_b3_r8, // BIT 4,B
    [0x61] = op_bit_b3_r8, // BIT 4,C
    [0x62] = op_bit_b3_r8, // BIT 4,D
    [0x63] = op_bit_b3_r8, // BIT 4,E
    [0x64] = op_bit_b3_r8, // BIT 4,H
    [0x65] = op_bit_b3_r8, // BIT 4,L
    [0x66] = op_bit_b3_r8, // BIT 4,[HL]
    [0x67] = op_bit_b3_r8, // BIT 4,A
    [0x68] = op_bit_b3_r8, // BIT 5,B
    [0x69] = op_bit_b3_r8, // BIT 5,C
    [0x6A] = op_bit_b3_r8, // BIT 5,D
    [0x6B] = op_bit_b3_r8, // BIT 5,E
    [0x6C] = op_bit_b3_r8, // BIT 5,H
    [0x6D] = op_bit_b3_r8, // BIT 5,L
    [0x6E] = op_bit_b3_r8, // BIT 5,[HL]
    [0x6F] = op_bit_b3_r8, // BIT 5,A
    [0x70] = op_bit_b3_r8, // BIT 6,B
    [0x71] = op_bit_b3_r8, // BIT 6,C
    [0x72] = op_bit_b3_r8, // BIT 6,D
    [0x73] = op_bit_b3_r8, // BIT 6,E
    [0x74] = op_bit_b3_r8, // BIT 6,H
    [0x75] = op_bit_b3_r8, // BIT 6,L
    [0x76] = op_bit_b3_r8, // BIT 6,[HL]
    [0x77] = op_bit_b3_r8, // BIT 6,A
    [0x78] = op_bit_b3_r8, // BIT 7,B
    [0x79] = op_bit_b3_r8, // BIT 7,C
    [0x7A] = op_bit_b3_r8, // BIT 7,D
    [0x7B] = op_bit_b3_r8, // BIT 7,E
    [0x7C] = op_bit_b3_r8, // BIT 7,H
    [0x7D] = op_bit_b3_r8, // BIT 7,L
    [0x7E] = op_bit_b3_r8, // BIT 7,[HL]
    [0x7F] = op_bit_b3_r8, // BIT 7,A
    // Type: RES b3, r8
    [0x80] = op_res_b3_r8, // RES 0,B
    [0x81] = op_res_b3_r8, // RES 0,C
    [0x82] = op_res_b3_r8, // RES 0,D
    [0x83] = op_res_b3_r8, // RES 0,E
    [0x84] = op_res_b3_r8, // RES 0,H
    [0x85] = op_res_b3_r8, // RES 0,L
    [0x86] = op_res_b3_r8, // RES 0,[HL]
    [0x87] = op_res_b3_r8, // RES 0,A
    [0x88] = op_res_b3_r8, // RES 1,B
    [0x89] = op_res_b3_r8, // RES 1,C
    [0x8A] = op_res_b3_r8, // RES 1,D
    [0x8B] = op_res_b3_r8, // RES 1,E
    [0x8C] = op_res_b3_r8, // RES 1,H
    [0x8D] = op_res_b3_r8, // RES 1,L
    [0x8E] = op_res_b3_r8, // RES 1,[HL]
    [0x8F] = op_res_b3_r8, // RES 1,A
    [0x90] = op_res_b3_r8, // RES 2,B
    [0x91] = op_res_b3_r8, // RES 2,C
    [0x92] = op_res_b3_r8, // RES 2,D
    [0x93] = op_res_b3_r8, // RES 2,E
    [0x94] = op_res_b3_r8, // RES 2,H
    [0x95] = op_res_b3_r8, // RES 2,L
    [0x96] = op_res_b3_r8, // RES 2,[HL]
    [0x97] = op_res_b3_r8, // RES 2,A
    [0x98] = op_res_b3_r8, // RES 3,B
    [0x99] = op_res_b3_r8, // RES 3,C
    [0x9A] = op_res_b3_r8, // RES 3,D
    [0x9B] = op_res_b3_r8, // RES 3,E
    [0x9C] = op_res_b3_r8, // RES 3,H
    [0x9D] = op_res_b3_r8, // RES 3,L
    [0x9E] = op_res_b3_r8, // RES 3,[HL]
    [0x9F] = op_res_b3_r8, // RES 3,A
    [0xA0] = op_res_b3_r8, // RES 4,B
    [0xA1] = op_res_b3_r8, // RES 4,C
    [0xA2] = op_res_b3_r8, // RES 4,D
    [0xA3] = op_res_b3_r8, // RES 4,E
    [0xA4] = op_res_b3_r8, // RES 4,H
    [0xA5] = op_res_b3_r8, // RES 4,L
    [0xA6] = op_res_b3_r8, // RES 4,[HL]
    [0xA7] = op_res_b3_r8, // RES 4,A
    [0xA8] = op_res_b3_r8, // RES 5,B
    [0xA9] = op_res_b3_r8, // RES 5,C
    [0xAA] = op_res_b3_r8, // RES 5,D
    [0xAB] = op_res_b3_r8, // RES 5,E
    [0xAC] = op_res_b3_r8, // RES 5,H
    [0xAD] = op_res_b3_r8, // RES 5,L
    [0xAE] = op_res_b3_r8, // RES 5,[HL]
    [0xAF] = op_res_b3_r8, // RES 5,A
    [0xB0] = op_res_b3_r8, // RES 6,B
    [0xB1] = op_res_b3_r8, // RES 6,C
    [0xB2] = op_res_b3_r8, // RES 6,D
    [0xB3] = op_res_b3_r8, // RES 6,E
    [0xB4] = op_res_b3_r8, // RES 6,H
    [0xB5] = op_res_b3_r8, // RES 6,L
    [0xB6] = op_res_b3_r8, // RES 6,[HL]
    [0xB7] = op_res_b3_r8, // RES 6,A
    [0xB8] = op_res_b3_r8, // RES 7,B
    [0xB9] = op_res_b3_r8, // RES 7,C
    [0xBA] = op_res_b3_r8, // RES 7,D
    [0xBB] = op_res_b3_r8, // RES 7,E
    [0xBC] = op_res_b3_r8, // RES 7,H
    [0xBD] = op_res_b3_r8, // RES 7,L
    [0xBE] = op_res_b3_r8, // RES 7,[HL]
    [0xBF] = op_res_b3_r8, // RES 7,A
    // Type: SET b3, r8
    [0xC0] = op_set_b3_r8, // SET 0,B
    [0xC1] = op_set_b3_r8, // SET 0,C
    [0xC2] = op_set_b3_r8, // SET 0,D
    [0xC3] = op_set_b3_r8, // SET 0,E
    [0xC4] = op_set_b3_r8, // SET 0,H
    [0xC5] = op_set_b3_r8, // SET 0,L
    [0xC6] = op_set_b3_r8, // SET 0,[HL]
    [0xC7] = op_set_b3_r8, // SET 0,A
    [0xC8] = op_set_b3_r8, // SET 1,B
    [0xC9] = op_set_b3_r8, // SET 1,C
    [0xCA] = op_set_b3_r8, // SET 1,D
    [0xCB] = op_set_b3_r8, // SET 1,E
    [0xCC] = op_set_b3_r8, // SET 1,H
    [0xCD] = op_set_b3_r8, // SET 1,L
    [0xCE] = op_set_b3_r8, // SET 1,[HL]
    [0xCF] = op_set_b3_r8, // SET 1,A
    [0xD0] = op_set_b3_r8, // SET 2,B
    [0xD1] = op_set_b3_r8, // SET 2,C
    [0xD2] = op_set_b3_r8, // SET 2,D
    [0xD3] = op_set_b3_r8, // SET 2,E
    [0xD4] = op_set_b3_r8, // SET 2,H
    [0xD5] = op_set_b3_r8, // SET 2,L
    [0xD6] = op_set_b3_r8, // SET 2,[HL]
    [0xD7] = op_set_b3_r8, // SET 2,A
    [0xD8] = op_set_b3_r8, // SET 3,B
    [0xD9] = op_set_b3_r8, // SET 3,C
    [0xDA] = op_set_b3_r8, // SET 3,D
    [0xDB] = op_set_b3_r8, // SET 3,E
    [0xDC] = op_set_b3_r8, // SET 3,H
    [0xDD] = op_set_b3_r8, // SET 3,L
    [0xDE] = op_set_b3_r8, // SET 3,[HL]
    [0xDF] = op_set_b3_r8, // SET 3,A
    [0xE0] = op_set_b3_r8, // SET 4,B
    [0xE1] = op_set_b3_r8, // SET 4,C
    [0xE2] = op_set_b3_r8, // SET 4,D
    [0xE3] = op_set_b3_r8, // SET 4,E
    [0xE4] = op_set_b3_r8, // SET 4,H
    [0xE5] = op_set_b3_r8, // SET 4,L
    [0xE6] = op_set_b3_r8, // SET 4,[HL]
    [0xE7] = op_set_b3_r8, // SET 4,A
    [0xE8] = op_set_b3_r8, // SET 5,B
    [0xE9] = op_set_b3_r8, // SET 5,C
    [0xEA] = op_set_b3_r8, // SET 5,D
    [0xEB] = op_set_b3_r8, // SET 5,E
    [0xEC] = op_set_b3_r8, // SET 5,H
    [0xED] = op_set_b3_r8, // SET 5,L
    [0xEE] = op_set_b3_r8, // SET 5,[HL]
    [0xEF] = op_set_b3_r8, // SET 5,A
    [0xF0] = op_set_b3_r8, // SET 6,B
    [0xF1] = op_set_b3_r8, // SET 6,C
    [0xF2] = op_set_b3_r8, // SET 6,D
    [0xF3] = op_set_b3_r8, // SET 6,E
    [0xF4] = op_set_b3_r8, // SET 6,H
    [0xF5] = op_set_b3_r8, // SET 6,L
    [0xF6] = op_set_b3_r8, // SET 6,[HL]
    [0xF7] = op_set_b3_r8, // SET 6,A
    [0xF8] = op_set_b3_r8, // SET 7,B
    [0xF9] = op_set_b3_r8, // SET 7,C
    [0xFA] = op_set_b3_r8, // SET 7,D
    [0xFB] = op_set_b3_r8, // SET 7,E
    [0xFC] = op_set_b3_r8, // SET 7,H
    [0xFD] = op_set_b3_r8, // SET 7,L
    [0xFE] = op_set_b3_r8, // SET 7,[HL]
    [0xFF] = op_set_b3_r8, // SET 7,A
};
