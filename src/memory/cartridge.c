...
static const cartridge_type_info_t cartridge_types[256] = {
    ...
    [0x0F] = {&mbc3_ops, "MBC3+TIMER+BATTERY", false, true},
    [0x10] = {&mbc3_ops, "MBC3+TIMER+RAM+BATTERY", true, true},
    [0x11] = {&mbc3_ops, "MBC3", false, false},
    [0x12] = {&mbc3_ops, "MBC3+RAM", true, false},
    [0x13] = {&mbc3_ops, "MBC3+RAM+BATTERY", true, true},
