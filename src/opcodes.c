...
opcode_fn opcode_cb_table[256] = {
    ...
    // Type: BIT b3, r8
    [0x50] = op_res_b3_r8, // RES 0,B
    [0x51] = op_res_b3_r8, // RES 0,C
    [0x52] = op_res_b3_r8, // RES 0,D
    [0x53] = op_res_b3_r8, // RES 0,E
    [0x54] = op_res_b3_r8, // RES 0,H
    [0x55] = op_res_b3_r8, // RES 0,L
    [0x56] = op_res_b3_r8, // RES 0,[HL]
    [0x57] = op_res_b3_r8, // RES 0,A
    [0x58] = op_res_b3_r8, // RES 1,B
    [0x59] = op_res_b3_r8, // RES 1,C
    [0x5A] = op_res_b3_r8, // RES 1,D
    [0x5B] = op_res_b3_r8, // RES 1,E
    [0x5C] = op_res_b3_r8, // RES 1,H
    [0x5D] = op_res_b3_r8, // RES 1,L
    [0x5E] = op_res_b3_r8, // RES 1,[HL]
    [0x5F] = op_res_b3_r8, // RES 1,A
    [0x60] = op_res_b3_r8, // RES 2,B
    [0x61] = op_res_b3_r8, // RES 2,C
    [0x62] = op_res_b3_r8, // RES 2,D
    [0x63] = op_res_b3_r8, // RES 2,E
    [0x64] = op_res_b3_r8, // RES 2,H
    [0x65] = op_res_b3_r8, // RES 2,L
    [0x66] = op_res_b3_r8, // RES 2,[HL]
    [0x67] = op_res_b3_r8, // RES 2,A
    [0x68] = op_res_b3_r8, // RES 3,B
    [0x69] = op_res_b3_r8, // RES 3,C
    [0x6A] = op_res_b3_r8, // RES 3,D
    [0x6B] = op_res_b3_r8, // RES 3,E
    [0x6C] = op_res_b3_r8, // RES 3,H
    [0x6D] = op_res_b3_r8, // RES 3,L
    [0x6E] = op_res_b3_r8, // RES 3,[HL]
    [0x6F] = op_res_b3_r8, // RES 3,A
    [0x70] = op_res_b3_r8, // RES 4,B
    [0x71] = op_res_b3_r8, // RES 4,C
    [0x72] = op_res_b3_r8, // RES 4,D
    [0x73] = op_res_b3_r8, // RES 4,E
    [0x74] = op_res_b3_r8, // RES 4,H
    [0x75] = op_res_b3_r8, // RES 4,L
    [0x76] = op_res_b3_r8, // RES 4,[HL]
    [0x77] = op_res_b3_r8, // RES 4,A
    [0x78] = op_res_b3_r8, // RES 5,B
    [0x79] = op_res_b3_r8, // RES 5,C
    [0x7A] = op_res_b3_r8, // RES 5,D
    [0x7B] = op_res_b3_r8, // RES 5,E
    [0x7C] = op_res_b3_r8, // RES 5,H
    [0x7D] = op_res_b3_r8, // RES 5,L
    [0x7E] = op_res_b3_r8, // RES 5,[HL]
    [0x7F] = op_res_b3_r8, // RES 5,A
    [0x80] = op_res_b3_r8, // RES 6,B
    [0x81] = op_res_b3_r8, // RES 6,C
    [0x82] = op_res_b3_r8, // RES 6,D
    [0x83] = op_res_b3_r8, // RES 6,E
    [0x84] = op_res_b3_r8, // RES 6,H
    [0x85] = op_res_b3_r8, // RES 6,L
    [0x86] = op_res_b3_r8, // RES 6,[HL]
    [0x87] = op_res_b3_r8, // RES 6,A
    [0x88] = op_res_b3_r8, // RES 7,B
    [0x89] = op_res_b3_r8, // RES 7,C
    [0x8A] = op_res_b3_r8, // RES 7,D
    [0x8B] = op_res_b3_r8, // RES 7,E
    [0x8C] = op_res_b3_r8, // RES 7,H
    [0x8D] = op_res_b3_r8, // RES 7,L
    [0x8E] = op_res_b3_r8, // RES 7,[HL]
    [0x8F] = op_res_b3_r8, // RES 7,A
};
